...
public class ArbolB {
    ...
    private void mostrarB(String dato) throws Exception {
        ...
        if (raiz != null) {
            ...
            for (int i = 0; i < raiz.getPaginas().length; i++) {
                if (raiz.getPaginas()[i] != null) {
                    ...
                    b += "Nodo" + raiz.hashCode() + ":P" + i + "->" + "Nodo" + raiz.getPaginas()[i].hashCode() + ";\n";
                }
            }
